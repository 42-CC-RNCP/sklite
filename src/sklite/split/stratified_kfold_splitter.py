...
from .function import stratified_kfold_split
...
if __name__ == "__main__":
    ...
    # Create a StratifiedKfoldSplitter instance
    splitter = StratifiedKfoldSplitter(n_splits=3, shuffle=True, random_state=42)

    # Generate splits
    for X_train, y_train, X_test, y_test in splitter.split(X, y):
